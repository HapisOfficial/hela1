...
global.reloadHandler = function () {
  ...
  conn.welcome = '_Hai @user_\n _Selamat Datang Di Grup:_\n*@subject*'
  conn.bye = '_Selamat Tinggal @user!\nTerimakasih Telah Bergabung Di Grup._\n\n_Kalo Balik Jangan Lupa Bawa Gorengan Buat Anggota Disini._'
  conn.spromote = '_Selamat @user Sekarang jadi Admin nih._'
  conn.sdemote = '_Kasian... @user Sekarang Bukan Admin._'
